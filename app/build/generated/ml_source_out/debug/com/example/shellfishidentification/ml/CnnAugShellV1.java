package com.example.shellfishidentification.ml;
...
public final class CnnAugShellV1 {
  @NonNull
  private final Model model;

  private CnnAugShellV1(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "CNN_aug_shell_v1.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static CnnAugShellV1 newInstance(@NonNull Context context) throws IOException {
    return new CnnAugShellV1(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static CnnAugShellV1 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new CnnAugShellV1(context, options);
  }
