...
public final class AugShellMobilenet {
  @NonNull
  private final Model model;

  private AugShellMobilenet(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "Aug_Shell_mobileNet.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static AugShellMobilenet newInstance(@NonNull Context context) throws IOException {
    return new AugShellMobilenet(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static AugShellMobilenet newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new AugShellMobilenet(context, options);
  }
